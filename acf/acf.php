...
*/
include "recover/acf-recover.php";
include "repeater/acf-repeater.php";
include "contactform7/acf-cf7.php";
include "limiter/acf-limiter.php";
include "paypal/acf-paypal.php";
include "wysiwyg/acf-wp_wysiwyg.php";
if( !class_exists('acf') ):
